...
<?php include("header/statistical_report_header.php"); ?>
<div align="center">
    
    <form action="statistical_report_r3_excel_file.php" method="post">
<table style="border:gray 1px solid;" cellpadding="5">
	<tr>
		<td colspan="2" class="header">STATISTICAL REPORT R3<BR></td>
	</tr>
	</tr>
		<td width="45%" class="question"><b>YEAR : </b></td>
		<td><input type="text" name="year" id="datepicker-example11" value="<?php echo $_POST['year']; ?>" class="a"></td>
	</tr>
	<tr>
