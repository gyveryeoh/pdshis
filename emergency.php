...
include("emergency_status.php");

//Registration Status and Hospital ID
$query = mysql_query("SELECT registration_status,hospital_id FROM emergency where patients_info_id  ='$patient_info_id'");
...
//Submit the form.HIN
if (isset($_POST['save']))
if (empty($_POST['date_referred']) || ($_POST['hour'] == "hour") || ($_POST['min'] == "min") || ($_POST['hour1'] == "hour1") || ($_POST['min1'] == "min1") || ($_POST['consultant'] == "0") || empty($_POST['management_plan']) || empty($_POST['room']) || empty($_POST['bed']) || empty($_POST['referring_md']) || empty($_POST['specialty'])){
...
//VOID DUPLICATE ENTRIES OF DATE REFERRED PER PATIENTS
		$duplicate=mysql_query("SELECT date_referred, patients_info_id FROM emergency where date_referred='$d_o_c' and patients_info_id='".$_POST['patients_info_id']."'");
	...
	else
	{
		...
		$emergency_id=mysql_insert_id();
		//Insert data in in patient details
		$query1 = mysql_query("insert into emergency_details values
				     ('',
				     '$emergency_id',
		...
		echo "<META HTTP-EQUIV='Refresh' CONTENT='1; URL=emergency.php?patients_info_id=$_POST[patients_info_id]'>";
		}
}
?>
<script>
...
<style>
 ...
 .ui-autocomplete { height: 200px; overflow-y: scroll; overflow-x: hidden;}
	...
	<div align="center">
	<form autocomplete="off" action="emergency.php" method="post">
	...
	<tr>
		<td colspan="2" class="header">EMERGENCY REGISTRATION</td>
	</tr>
		<td class="question" width="25%">Date Referred : </td>
		<td><input type="text" name="date_referred" id="datepicker-example11" value="<?php echo $_POST['date_referred']; ?>" class="a">&nbsp;<font size="1px"><b>mm/dd/yyyy</b></font><?php echo $required; ?></td>
	</tr>
	<tr>
	...
	<tr>
	    ...
	    <option value="hour">HOUR</option>
			...
			<option value="AM" <?php if ($_POST['time'] == "AM") { echo 'selected'; } ?>>AM</option>
			<option value="PM" <?php if ($_POST['time'] == "PM") { echo 'selected'; } ?>>PM</option>
	...
	<tr>
	    ...
	    <option value="hour1">HOUR</option>
			...
			<option value="AM" <?php if ($_POST['time1'] == "AM") { echo 'selected'; } ?>>AM</option>
			<option value="PM" <?php if ($_POST['time1'] == "PM") { echo 'selected'; } ?>>PM</option>
			</select><?php echo $required; ?>
	    </td>
	</tr>
	<tr>
	...
	<tr>
       ...
       <tr>
		 ...
		 <td class="regis ans"><input type="radio" name="for_admission" value="N" checked="checked" <?php if ($_POST['for_admission'] == 'N') { echo 'checked'; } ?>>No <input type="radio" name="for_admission" value="Y" <?php if ($_POST['for_admission'] == 'Y') { echo 'checked'; } ?>> Yes </td>
       </tr>
       <tr>
