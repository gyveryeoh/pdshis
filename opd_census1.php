...
include("../top header/report_design.php");
?>
<?php
...
<table style="border:gray 1px solid;" border="1" class="search">
    <form name="monthlyreport" action="opd_census1.php" method="post">
	<tr>
